        ...
        <>
            ...
            <div className={`policy-section inherit-grid`}>
                ...
                <div className="payments-section section">
                    ...
                    <h3>Cash Payments</h3>
                    Cash payments can be sent to our P.O. Box. Currently we accept USD and more currencies will be accepted at a later date. Each payment sent will need to include a printed activation code that is generated by our platform. This code is a one-time only payment code and is deleted once the payment has been registered.
