  ...
  return (
    ...
    <div className={`first-features grid-row-${props.row} inherit-grid`}>
      ...
      <div className="s1 box">
        <img className="img" src="https://raw.githubusercontent.com/tunnels-is/media/master/nl-website/v2/globe-shield-icon.svg"></img>
      ...
      <div className="s2 box">
        <img className="img" src="https://raw.githubusercontent.com/tunnels-is/media/master/nl-website/v2/laptop.svg"></img>
      ...
      <div className="s3 box">
        <img className="img" src="https://raw.githubusercontent.com/tunnels-is/media/master/nl-website/v2/lock-icon.svg"></img>
        <div className="item-title font-section-item-title">IP-Free routing data</div>
        <div className="description font-section-description">
