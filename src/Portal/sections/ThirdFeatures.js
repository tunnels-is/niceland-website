  ...
  return (
    ...
    <div className={`third-features grid-row-${props.row} inherit-grid bg-${props.bg}`}>
      ...
      <div className="s2 box">
        ...
        <div className="description font-section-description">
          When possible Niceland will send your traffic across continents using datacenter private routing. These private routes have a higher capacity for bandwidth than the public internet and in some cases can provide a boost in internet speed (latency)
          <br />
          <br />
