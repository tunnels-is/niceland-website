  ...
  return (
    < div className={`about grid-row-${props.row} inherit-grid`}>
      ...
      <div className="subtitle font-big-section-description">
        ...
        <br></br>
        <br></br>
        Niceland VPN was built from the ground up with anonimity at it's core. Every decision we make is centerd around keeping our users data anonymous. How the platform was built, how data is stored, what third party providers to use, even where we registered the company.
