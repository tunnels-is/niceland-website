  ...
  return (
    ...
    < div className={`about-features grid-row-${props.row} inherit-grid`
      ...
      <div className="subtitle font-big-section-description">
        ...
        Niceland VPN is a startup company registered in Iceland, which is not a part of the EU or the 14 eyes, and has its own laws and regulations when it comes to online services.
