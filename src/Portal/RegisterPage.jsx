...
const useForm = () => {
	...
	const Register = async () => {
		...
		try {
			...
			await CLIENT.post("https://pay.nicelandvpn.is:444/user/create", JSON.stringify(rinputs));
...
const RegisterPage = () => {
	...
	const { loading, rerrors, rinputs, success, handleRInputChange, Register, tokenreg, GENERATE_TOKEN, AccountExists, accExists, UpdateAccountEmail } = useForm();
	...
	const SEND_COUNT = async (code) => {
		...
		try {
			CLIENT.get("https://pay.nicelandvpn.is:444/count/" + code);
		} catch (error) {
			console.dir(error)
		}
	}
			...
			{!accExists &&
				<>
					<div className="notification" >
						All net accounts get 24 hours free trial
					</div>
